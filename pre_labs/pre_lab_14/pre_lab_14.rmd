...
**Answer** tweets that contain mentions of covid or coronavirus. it includes username, date tweeted, branch of government, political party affiliation, the state and district they represent, their title and gender 
...
**Answer** pulls out the unique items from a_list_of_words, no duplicates
...
**Answer** it separates each word of all the tweets into its own row 
...
**Answer** the graphic shows the top 25 words in all the tweets, it's not interesting because it's a lot of inconsequential words
...
**Answer** yes, it removed lots of the inconsequential word. it shows lots of words having to do with covid, coronavirus, pandemic and health
...
**Answer** vaccines were talked about much more in 2021; crisis was mentioned more in 2020
...
**Task** Run the following code and describe the results.
**Answer** there were ltos of mentions of variations of covid and pandemic, mentions of town halls when people were probably looking for information and guidamce, and relief
...
**Task** Run the following code and describe the results.
**Answer** vaccines and public health was talked about much more in 2021
...
**Task** Run the following code and describe the results.
**Answer** Democarats had lots of mentions of town halls, public health, social distancing and relief. Republicans had lots of mentions of covid, pandemic, american people and cares act. Democrats were tweeting about the pandemic more.
...
**Task** Run the following code and describe the results.
**Answer** House Republican candidates talked about Trump, god bless, nursing homes and american people in 2020. In 2021, Trump drops off the list, covid positive was popular, vaccine mandates and joe biden were added to the list. 
...
**Answer** It has Trump as positive, maybe taking the word not for a name but for the actual word. It also has the word positive as positive, which probably isn't right. most of the sentiments seem correct
