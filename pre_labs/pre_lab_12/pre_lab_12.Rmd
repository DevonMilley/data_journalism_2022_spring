...
**Answer** dataframe with 11397 rows, 13 columns, lists Maryland vaccinations by county
...
**Answer** There are 284 vaccination records that don't have a county listed 
...
**Answer** The first row shows 8000 doses given on 1/8/2021, and the following rows either have one or no doses given. This indicates there was probably a mass vaccination of people in which the county column would be irrelevant information. Those people could include military, hospital workers, older people and immunocompromised people, among others.
...
**Answer** a dataframe of Prince George's vaccinations by day, arranged by vaccination date; the last 7 to 10 days had at least more than 100 vaccinations, but the most recent day only had 32 vaccinations.
...
**Answer** The number of vaccinations decreased a lot around May/June 2021 and then leveled out.
...
**Answer** a line chart showing Maryland counties' COVID cases by date. Most counties seemed to have a large spike right before January 2022.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** This chart shows Maryland counties' covid cases by date. It shows large increases right at the beginning and then the start of leveling out before January 2021. 
...
**Answer** a map of Maryland counties on 4-18-2022, with counties closer to yellow having more cases and counties closer to blue having fewer cases.
