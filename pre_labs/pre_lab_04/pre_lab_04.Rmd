...
**Answer** Error: Can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>.
...
**Answer** Lots of demograpihc data is missing because the zip codes in the PPP data were not all five digits, meaning they didn't match with the zcta.
