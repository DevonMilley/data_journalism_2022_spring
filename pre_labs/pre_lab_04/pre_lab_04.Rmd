...
**Answer** Error: Can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>. The error means that the datasets can't be joined where we specified because those two columns' data types don't match. 
...
**Answer** Lots of demographic data is missing because the zip codes in the PPP data were not all five digits, meaning they didn't match with the zcta.
...
**Answer** number of loans that went to ZCTAs with more than 50% non-Hispanic Black population: 41,968; average loan amount: \$55,546.84; median loan amount: \$19,949
...
**Answer** number of loans that went to ZCTAs with more than 50% non-Hispanic white population: 112,056; average loan amount: \$89,194.67; median loan amount: \$20,833
...
**Answer** number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population, rural: 145; average loan amount: \$44,815.22; median loan amount: \$19,064.57; number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population, urban: 41,823; average loan amount: \$55,584.05; median loan amount: \$19,950
...
**Answer** number of PPP loans that went to ZCTAs with more than 50% non-Hispanic white population, rural: 18,083; average loan amount: \$74,463.32; median loan amount: \$20,833; number of PPP loans that went to ZCTAs with more than 50% non-Hispanic white population, urban: 93,973; average loan amount: \$92,029.39; median loan amount: \$20,833
