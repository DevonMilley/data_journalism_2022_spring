...
**Answer** tells you which presidential candidate won in each U.S. state, the percentage of votes for Trump, the percent of businesses that got PPP loans
```{r}
...
**Answer** positive relationship between the percent of Trump votes in a particular state to how many businesses got PPP loans
```{r}
...
### Task 4: Plot data
**Task** Run the following code. Describe the plot. What do you see?
**Answer** not as much correlation between the loan amount businesses got to percent of Trump votes
```{r}
...
**Answer** percent of businesses receiving ppp has a pretty high correlation to the percent of Trump cotes; the other one has a weaker positive correlation
```{r}
reveal_data %>%
...
**Answer** the p value is very small, indicating that there is a very low chance the correlation is random
```{r}
