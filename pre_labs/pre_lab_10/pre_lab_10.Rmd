...
**Answer** https://datawrapper.dwcdn.net/4S04x/1/
...
**Answer** The code creates a dataframe called md_counties that counts how many loans are in each Maryland county (grouping).
...
**Answer** This code does the same thing as the above code block and then filters out counties by only selecting ones that have more than 6 loans
...
a dataframe of the number approved applications by county in maryland
...
**Answer** It zooms in to just Maryland
...
**Answer** the fips code became the county name, andn the count was formatted to include commas
...
**Answer** https://datawrapper.dwcdn.net/znwFe/1/
