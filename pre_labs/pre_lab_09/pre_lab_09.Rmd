...
**Answer** first we create a new dataframe from the ppp_maryland data and group it by county. Then, we summarise the total loans using the n() count function. Then, we arrange the counties by biggest total loans and only show the first ten counties.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** a column chart of the counties and a count of their total loans
...
**Answer** the counties have been reordered be ascending by count
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** there is no more background color, you can see the grid clearer
...
**Answer** The chart now has a blue background. Instead of a grid in the background, it is now just white lines.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The axis labels have been cleaned up and spaced away from the graph, there is a title and a source attribution
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** a tibble with the number of loans approved on a specific date
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** a line graph of the number of loans approved on a specific graph
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** the grid in the background became smaller, there are more dates on the x axis
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** the dates are more spaced out and angled so that it's more readable
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
