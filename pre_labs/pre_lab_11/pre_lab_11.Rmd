...
**Answer** a list of hospitals file, all with different file types
...
**Answer** a data frame with 7581 rows and 33 columns, it has information about hospitals and their locations 
...
**Answer** a list of hospitlas in Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a tibble of the total hospitals grouped and counted by type
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** general acute care hospitals in Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maryland hospitals plotted on a grid using latitude and longitude
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** loaded the library Tigris
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a data frame with 3234 rows and 18 columns. gives information about counties
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** data frame of Maryland counties, using the fips code
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a map of Maryland divided by county, with the bay filled in
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** plots the locations of hospitals onto a map of Maryland counties
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** plots the locations of hospitals in Maryland and designates a color to the point based on the number of beds the hospital has. Rural area hospitals have less capacity than urban area hospitals
...
**Answer** loaded libraries and census api key
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a data frame of general acute hospitals in maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** hospital capacity grouped by county, Baltimore City and Montgomery County have the highest hospital capacity
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** the population of each Maryland county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a dataframe of maryland county population
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** two data frames, one with maryland county populations and one with maryland hospital capacities
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a data frame that changed the county column to match the hospital capacity data frame
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a data frame that joins the maryland county population data and the maryland hospital capacity data
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** makes sure a place with no beds has a value of zero instead of NA
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** a data frame that calculates the number of hospital beds per 100,000 people in Maryland counties
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Rural counties have less hospital counties, probably because there are less people in those counties. The counties with the greatest hospitla capacity are the urban counties such as Baltimore City
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** changes the color of the beds per 100,000 people 
...
**Answer** Makes the legend more specific to more clearly see differences in each county's hospital capacity. urban areas have more hospital capacity than rural areas.
