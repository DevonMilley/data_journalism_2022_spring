...
top_and_bottom_five_states <- all_the_apps_percent_undisbursed %>% 
  arrange(desc(percent_apps_with_undisbursed_amounts)) %>% 
  head(5) %>% 
  tail(5)
  
write_csv(top_and_bottom_five_states, "top_and_bottom_five_states.csv")
```
